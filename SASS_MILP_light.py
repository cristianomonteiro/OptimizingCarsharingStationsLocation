...
class Edge:    
    def __init__(self, u, v, idEdge, utilityValue, alphaEdgesSet, omegaEdgesSet, variablesAlreadyCreated, model):
        self.idEdge = idEdge
        self.u = u
        self.v = v
        self.utilityValue = utilityValue
...
def buildGurobiModel(nIterations=0, distanceCutOff=200):
    ...
    for u, v, data in G.edges(data=True):
        ...
        edge = LightEdge(G, u, v, data['idedge'], data['utilityvalue'], distanceCutOff)
        GList.append((edge.u, edge.v, edge.idEdge, edge.utilityValue, edge.alphaEdgesSet, edge.omegaEdgesSet))
    ...
    for u, v, idEdge, utilityValue, alphaEdgesSet, omegaEdgesSet in GList:
        if utilityValue == 0:
            continue
        ...
        edge = Edge(u, v, idEdge, utilityValue, alphaEdgesSet, omegaEdgesSet, False, model)
    ...
    while len(GList) > 0:
        u, v, idEdge, utilityValue, alphaEdgesSet, omegaEdgesSet = GList.pop(0)
        if utilityValue == 0:
            continue
        ...
        edge = Edge(u, v, idEdge, utilityValue, alphaEdgesSet, omegaEdgesSet, True, model)
...
for nIter in nIterationsList:
    ...
    for i in range(numRuns):
        ...
        try:
            ...
            #modelSASS.optimize()
            print("Starting to write the model")
